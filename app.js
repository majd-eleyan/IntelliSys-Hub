// (الأعوام الدراسية ومساقات التخصص)
...
// --------------------------------------------------
// (بدء تشغيل التطبيق وقراءة الإعدادات)
// --------------------------------------------------
...
// --------------------------------------------------
//  (خانة البحث العامة في الـ Header)
// --------------------------------------------------
...
// --------------------------------------------------
// (تصغير Header عند التمرير على الجوال)
// --------------------------------------------------
...
// --------------------------------------------------
//  (أدوات التحكم بالقائمة الجانبية المتقدمة)
// --------------------------------------------------
...
function setupEventListeners() {
  ...
  // Handle window resize to clean up mobile sidebar state
...
async function fetchFolderItems(folderId, folderName) {
  ...
  if (isDemoMode) {
    ...
    try {
      ...
      renderErrorState("فشل جلب الملفات   ", " تحقق من الاتصال بالإنترنت.");
    }
  }
}
...
// --------------------------------------------------
// (التحقق من المجلدات وحجب الفارغ)
// --------------------------------------------------
...
// --------------------------------------------------
// (بناء عناصر مستعرض التخزين السحابي)
// --------------------------------------------------
